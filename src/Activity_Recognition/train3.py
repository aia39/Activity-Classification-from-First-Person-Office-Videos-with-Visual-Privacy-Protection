...
def test_model(epoch):
    ...
    if ACCURACY < final_acc:    
        ...
        torch.save(model.state_dict(), f"model_checkpoints/{model.__class__.__name__}_{epoch}for_wide_resnet_with_attention_image_size_324_best_{final_acc}(full_data).pth")
    ...
    plt.savefig(f"score{epoch}for_with_accuracy{final_acc}.png")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--img_dim", type=int, default=324, help="Height / width dimension")
