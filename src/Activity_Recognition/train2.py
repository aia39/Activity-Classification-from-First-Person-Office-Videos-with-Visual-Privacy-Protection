...
def test_model(epoch):
    ...
    if ACCURACY < final_acc:    
        ...
        torch.save(model.state_dict(), f"model_checkpoints/{model.__class__.__name__}_{epoch}for_wide_densenet_image_size_248_best_{final_acc}(full_data).pth")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch_size", type=int, default=5, help="Size of each training batch")
    parser.add_argument("--sequence_length", type=int, default=40, help="Number of frames used in each video")
    parser.add_argument("--img_dim", type=int, default=512, help="Height / width dimension")
